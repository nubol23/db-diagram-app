...
const App: React.FC = () => {
    ...
    const [comparableDiagram, setComparableDiagram] = useState<ComparableDiagram>({nodes: [], edges: []})
    ...
    return (
        <ReactFlowProvider>
            <Diagram handleDiagramState={setComparableDiagram} handleExportTrigger={setClickTrigger}/>
        </ReactFlowProvider>
    );
};
